                        ...
                        <div class="card bg-light border-0 rounded-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group mb-3" role="group">
                                    <input type="radio" class="btn-check" name="video_type" value="youtube" id="video_type_youtube" {{ old('video_type') != 'file' ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="video_type_youtube">
                                        <i class="bi bi-youtube me-2"></i>YouTube URL
                                    </label>

                                    <input type="radio" class="btn-check" name="video_type" value="file" id="video_type_file" {{ old('video_type') == 'file' ? 'checked' : '' }}>
