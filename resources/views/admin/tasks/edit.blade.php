        ...
        @endif
            ...
            <form action="{{ route('admin.tasks.update', $task->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="number" name="points" id="points" class="form-control" value="{{ old('points', $task->points) }}" required>
                        ...
                        <div class="card bg-light border-0 rounded-3">
                            <div class="card-body">
                                ...
                                <div class="btn-group mb-3" role="group">
                                    <input type="radio" class="btn-check" name="video_type" value="youtube" id="video_type_youtube" {{ old('video_type', $task->video_type) != 'file' ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary" for="video_type_youtube">
                                        <i class="fab fa-youtube me-2"></i>YouTube URL
                                    </label>

                                    <input type="radio" class="btn-check" name="video_type" value="file" id="video_type_file" {{ old('video_type', $task->video_type) == 'file' ? 'checked' : '' }}>
                                ...
                                <div id="video_url_group">
                                    <div class="form-floating">
                                        <input type="url" name="video_url" id="video_url" class="form-control" value="{{ old('video_url', $task->video_url) }}">
                            ...
                            <div class="card bg-light border-0 rounded-3 mb-3">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ $task->thumbnail_url }}" alt="Current Thumbnail" class="rounded-3" style="max-width: 200px;">
                                        <div class="ms-3">
                    ...
                    <div class="col-12">
                        <div class="form-check form-switch">
                            <input type="checkbox" 
                                ...
                                {{ old('featured', $task->featured) ? 'checked' : '' }}>
