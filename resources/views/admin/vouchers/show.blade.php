                ...
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <span
                                class="badge bg-{{ $voucher->status === 'active' ? 'success' : 'danger' }}-subtle 
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="color-preview me-2" style="background-color: {{ $voucher->background_color }}">
                                </div>
                    ...
                    <div class="card-body p-4">
                                    ...
                                    <tbody>
                                        @foreach ($redemptions as $redemption)
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        @if ($redemption->user->profile_image)
                                                            <img src="{{ asset('storage/' . $redemption->user->profile_image) }}"
                                                                class="rounded-circle me-2" width="32" height="32"
                                                                alt="{{ $redemption->user->name }}'s Avatar">
                                                        @else
                        ...
                        @else
                            <div class="text-center py-4">
                                <img src="{{ asset('images/no-data.svg') }}" alt="No redemptions" class="mb-3"
                                    width="150">
